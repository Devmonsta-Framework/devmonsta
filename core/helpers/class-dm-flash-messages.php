...
class DEVM_Flash_Messages {
    ...
    private static function get_messages() {
        ...
        if ( empty( $messages ) || !is_array( $messages ) ) {
            $messages = array_fill_keys( array_keys( self::$available_types ), [] );
        }
     ...
     */
    public static function add( $id, $message, $type = 'info', array $removed_ids = [] ) {
     ...
     * @internal
     */
    public static function print_backend_protected() {
     ...
     */
    public static function print_frontend_protected() {
        self::process_pending_remove_ids();
    ...
    public static function frontend_printed_protected() {
        return self::$frontend_printed;
    }

    public static function get_messages_protected( $clear = false ) {
        self::process_pending_remove_ids();
     ...
     * @since 2.6.15
     */
    public static function clear_protected() {
        self::set_messages( [] );
    }
