...
<div class="about-wrap wrap dms-container">
	...
	<?php ob_start();?>
	<h1 class="dms--importer-title"><span class="dms--importer-title__icon dms dms-cog-icon1"></span><?php esc_html_e( 'Devmonsta Demo Install', 'devmonsta' );?></h1>
	<?php
							...
							<div class="dms--demo-preivew-inner">
								...
								<div class="card-body">
									...
									<div class="dms-preview-btn-list">
										<a href="#" class="attr-btn-primary dms-preview-btn"><span class="dms-preview-btn-icon dms dms-laptop"></span><?php esc_html_e( 'Preview', 'devmonsta' );?></a>

										<button data-required-plugin='<?php echo json_encode( $single_demo_file['required_plugin'] ); ?>' class="dms-special-preview-btn dms_import_btn btn attr-btn-primary" data-nonce="<?php echo esc_attr( $nonce ); ?>" data-name="<?php echo esc_attr( $single_demo_file["import_title"] ); ?>" data-xml_link="<?php echo esc_url( $single_demo_file['import_file_url'] ); ?>"><span class="dms-special-preview-btn-icon dms dms-download1"></span><?php echo esc_html__( 'Import', 'devmonsta' ); ?></button>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="dms-single-content">
					<div class="dms-importer-data">
						<div class="dms-single-importer welcome" data-step="welcome">
							<h1 class="dms-importer-data--welcome-title"><?php esc_html_e( 'Welcome Back!', 'devmonsta' );?></h1>
						...
						<div class="dms-single-importer erase" data-step="erase">
							<h1 class="dms-importer-data--welcome-title"><?php esc_html_e( 'Erase Previous Data', 'devmonsta' );?></h1>
							<div class="dms-importer-data--welcome-text">
							...
							<div class="dms-importer-additional-data">
								<div class="dms-importer-checkbox">
									...
									<label for="dms_delete_data_confirm" class="dms-importer-check-label"><?php echo esc_html__( 'I do confirm.', 'devmonsta' ); ?></label>
								</div>
							</div>
						</div>

						<div class="dms-single-importer plugin_install" data-step="plugin_install">
							<h1 class="dms-importer-data--welcome-title"><?php esc_html_e( 'Required Plugins', 'devmonsta' );?></h1>
						...
						<div class="dms-single-importer content_import" data-step="content_import">
							<h2 class="dms-importer-data--progress-msg"><?php esc_html_e( 'Demo Content is in Progress', 'devmonsta' );?></h2>
							<h1 class="dms-importer-data--welcome-title"><?php esc_html_e( 'We are ready to import.', 'devmonsta' );?></h1>
						...
						<div class="dms-single-importer last_step" data-step="last_step">
							<h1 class="dms-importer-data--welcome-title"><?php esc_html_e( 'Welcome', 'devmonsta' )?></h1>
							<div class="dms-importer-data--welcome-text">
					...
					<div class="dms-importer-buttons">
						<div class="dms-importer-final-buttons">
							<button type="button" class="dms-btn dms-close-btn" data-dismiss="modal"><?php esc_html_e( 'Close', 'devmonsta' );?></button>
							<a target="_blank" class="dms-btn dms-special-btn" href="<?php echo esc_url( get_home_url() ); ?>"><?php echo esc_html__( 'Preview', 'devmonsta' ); ?></a>
							<a target="_blank" class="dms-btn dms-special-btn" href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>"><?php echo esc_html__( 'Customise', 'devmonsta' ); ?></a>
						</div>
