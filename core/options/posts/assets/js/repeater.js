...
function resetRepeater(clonedElement){
    ...
    jQuery(window).trigger('devm-scripts-typo.dm', [clonedElement]);
    // gradient
    jQuery(window).trigger('devm-scripts.gradient', [clonedElement]);
    // datetime Range
    jQuery(window).trigger('devm-scripts.datetimeRange', [clonedElement]);
    // Date Picker
    jQuery(window).trigger('devm-scripts.datePicker', [clonedElement]);
    // colorpicker
    jQuery(window).trigger('devm-scripts.colorPicker', [clonedElement]);
    // datetime picker
    jQuery(window).trigger('devm-scripts.datetimePicker', [clonedElement]);
}