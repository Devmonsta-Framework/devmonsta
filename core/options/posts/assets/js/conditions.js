jQuery(document).ready(function($){
    ...
    $(document).on('input change','.devm-ctrl', function(e, val){
        var currentControlValue = val ? val : $(this).val(),
            conditionalInputs = $('.devm-condition-active'),
            ...
            if(self.attr('type') == 'checkbox'){
                $(this).parents('.devm-option-column').find('input:checked').each(function(item){
                    values.push($(this).val());
                });
                currentControlValue = $(this).parents('.devm-option-column').find('input:checked').val();
            }
            // radio
        ...
        conditionalInputs.each(function(){
            var conditions = $(this).data('devm_conditions'),
                conditionField =  $(this);
