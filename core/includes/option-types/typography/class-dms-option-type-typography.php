 ...
 * Typography
 */
class DMS_Option_Type_Typography extends DMS_Option_Type
{
	/*
	 * Allowed fonts
	 */
	...
	public function get_fonts()
	{
		if($this->fonts === null) {
			$this->fonts = array(
				'standard' => apply_filters('dms_option_type_typography_standard_fonts', array(
					"Arial",
					"Verdana",
					"Trebuchet",
					"Georgia",
