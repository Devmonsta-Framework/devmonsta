...
<div <?php echo dms_attr_to_html($attr) ?>>
	<table class="dms-option-type-addable-option-options" width="100%" cellpadding="0" cellspacing="0" border="0">
		<?php $i = 1; ?>
		<?php foreach ($data['value'] as $option_value) : ?>
			<tr class="dms-option-type-addable-option-option dms-backend-options-virtual-context">
				<td class="td-move">
					<img src="<?php echo esc_url($move_img_src); ?>" width="7" />
				</td>
				<td class="td-option dms-force-xs">
					<?php
					echo dms()->backend->option_type($option['option']['type'])->render(
						$i,
						$option['option'],
						array(
							'value'       => $option_value,
				...
				<td class="td-remove">
					<a href="#" onclick="return false;" class="dashicons dms-x dms-option-type-addable-option-remove"></a>
				</td>
			</tr>
		<?php endforeach; ?>
	</table>
	<br class="default-addable-option-template dms-hidden" data-template="<?php
																			/**
																			...
																			$increment_placeholder = '###-addable-option-increment-' . dms_rand_md5() . '-###';
				...
				<td class="td-option dms-force-xs">' .
																					dms()->backend->option_type($option['option']['type'])->render(
	...
	<div><?php
			echo dms_html_tag('button', array(
				'type' => 'button',
				'class' => 'button dms-option-type-addable-option-add',
