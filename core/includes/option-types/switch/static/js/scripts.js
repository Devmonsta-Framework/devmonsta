jQuery(document).ready(function ($) {
	var optionTypeClass = 'dms-option-type-switch',
		customEventPrefix = 'dms:option-type:switch:';

	dmsEvents.on('dms:options:init', function (data) {
		data.$elements.find('.'+ optionTypeClass +':not(.dms-option-initialized)')
