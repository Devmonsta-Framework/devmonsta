...
class DMS_Option_Type_Icon extends DMS_Option_Type
{
	/**
	...
	{
		wp_enqueue_style(
			'dms-option-type-'. $this->get_type() .'-backend',
			dms_get_framework_directory_uri('/includes/option-types/'. $this->get_type() .'/static/css/backend.css'),
			dms()->manifest->get_version()
		);

		wp_enqueue_script(
			'dms-option-type-'. $this->get_type() .'-backend',
			dms_get_framework_directory_uri('/includes/option-types/'. $this->get_type() .'/static/js/backend.js'),
		...
		if (isset($sets[ $option['set'] ])) {
			...
			foreach($font_style_sources as $key => $style_source) {
				...
				if (!isset($this->enqueued_font_styles[ $style_hash ])) {
					wp_enqueue_style(
						"dms-option-type-{$this->get_type()}-font-{$option['set']}-{$style_hash}",
						$style_source,
						array(),
						dms()->manifest->get_version()
					);
	...
	protected function _render($id, $option, $data)
	{
		...
		return dms_render_view(dirname(__FILE__) . '/view.php', compact('id', 'option', 'data', 'set'));
	}
	...
	private function get_default_sets()
	{
		...
		//     groups => array(
		//         array(
		//             'title' => __('Web Application Icons', 'dms')
		//             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
		//         ),
		//         array(
		//             'title' => __('Transportation Icons', 'dms'),
		//             'icons' => array(...),
		//         ),
		//     )
		//
		...
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups' => array (
					'web-application' => __('Web Application Icons', 'dms'),
					//'accessibility' => __('Accessibility Icons', 'dms'),
					'hand' => __('Hand Icons', 'dms'),
					'transportation' => __('Transportation Icons', 'dms'),
					'gender' => __('Gender Icons', 'dms'),
					'file-type' => __('File Type Icons', 'dms'),
					//'spinner' => __('Spinner Icons', 'dms'),
					//'form-control' => __('Form Control Icons', 'dms'),
					'payment' => __('Payment Icons', 'dms'),
					//'chart' => __('Chart Icons', 'dms'),
					'currency' => __('Currency Icons', 'dms'),
					'text-editor' => __('Text Editor Icons', 'dms'),
					'directional' => __('Directional Icons', 'dms'),
					'video-player' => __('Video Player Icons', 'dms'),
					'brand' => __('Brand Icons', 'dms'),
					'medical' => __('Medical Icons', 'dms'),
				),
				'icons' => array(
