...
class DMS_Option_Type_Addable_Popup extends DMS_Option_Type
{
	...
	protected function _enqueue_static($id, $option, $data)
	{
		...
		if ($enqueue) {
			wp_enqueue_style(
				'dms-option-' . $option_type,
				dms_get_framework_directory_uri('/includes/option-types/' . $option_type . '/static/css/styles.css'),
				array('dms'),
			...
			wp_enqueue_script(
				'dms-option-' . $option_type,
				dms_get_framework_directory_uri('/includes/option-types/' . $option_type . '/static/js/scripts.js'),
	...
	protected function _render($id, $option, $data)
	{
		...
		return dms_render_view(
			dms_get_framework_directory('/includes/option-types/addable-popup/view.php'),
	...
	protected function _get_value_from_input($option, $input_value)
	{
		 ...
		 */
		return apply_filters('dms:option-type:addable-popup:value-from-input', $values, $option);
	}
...
class DMS_Option_Type_Addable_Popup_Full extends DMS_Option_Type_Addable_Popup
{
	public function get_type()
	{
	...
	protected function _render($id, $option, $data)
	{
		...
		$option['attr']['class'] .= ' dms-option-type-addable-popup';
