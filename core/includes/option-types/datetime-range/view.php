...
<div <?php echo dms_attr_to_html($wrapper_attr) ?> >
	...
	<?php echo dms()->backend->option_type( 'datetime-picker' )->render( 'from', array(
	...
	<div class="delimiter"><?php echo __('to', 'dms') ?></div>

	<?php echo dms()->backend->option_type( 'datetime-picker' )->render( 'to', array(
		'type'  => 'datetime-picker',
